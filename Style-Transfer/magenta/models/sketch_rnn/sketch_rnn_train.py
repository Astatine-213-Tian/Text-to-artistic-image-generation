...
tf.app.flags.DEFINE_string(
    ...
    'remotely.')
tf.app.flags.DEFINE_string(
    'log_root', '/tmp/sketch_rnn/checkpoint/default',
...
def download_pretrained_models(
    models_root_dir='/tmp/sketch_rnn/checkpoint',
    pretrained_models_url=PRETRAINED_MODELS_URL):
  """Download pretrained checkpoint to a temporary directory."""
  ...
  if os.path.isfile(zip_path):
    ...
    tf.logging.info('Downloading pretrained checkpoint from %s...',
