...
>>> python magenta/checkpoint/gansynth/train.py

To use a config of hyperparameters:
>>> python magenta/checkpoint/gansynth/train.py --config=mel_prog_hires
...
def main(unused_argv):
  ...
  if FLAGS.config:
    config_module = importlib.import_module(
        'magenta.checkpoint.gansynth.configs.{}'.format(FLAGS.config))
