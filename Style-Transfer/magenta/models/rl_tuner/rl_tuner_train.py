...
python magenta/checkpoint/rl_tuner/rl_tuner_train.py \
...
tf.app.flags.DEFINE_string('note_rnn_checkpoint_dir', '',
                           ...
                           'melody prediction checkpoint. These will be loaded into'
...
tf.app.flags.DEFINE_integer('exploration_steps', 500000,
                            'The number of steps over which the checkpoint'
...
tf.app.flags.DEFINE_string('exploration_mode', 'boltzmann',
                           ...
                           'boltzmann, which will sample from the checkpoint'
