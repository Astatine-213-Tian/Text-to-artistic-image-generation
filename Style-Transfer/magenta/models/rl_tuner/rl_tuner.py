...
class RLTuner(object):
  ...
  def initialize_internal_models_graph_session(self,
    ...
    """Initializes internal RNN checkpoint, builds the graph, starts the session.

    Adds the graphs of the internal RNN checkpoint to this graph, adds the DQN ops
    ...
    Args:
      restore_from_checkpoint: If True, the weights for the 'q_network',
        ...
        If false, these checkpoint will be initialized with random weights. Useful
  ...
  def reset_composition(self):
    """Starts the checkpoint internal composition over at beat 0, with no notes.
  ...
  def save_stored_rewards(self, file_name):
    """Saves the checkpoint stored rewards over time in a .npz file.
  ...
  def prime_internal_models(self):
    """Primes both internal checkpoint based on self.priming_mode.
