...
flags.DEFINE_string('output_dir', None,
                    'Directory to export TensorFlow Lite checkpoint.')
...
flags.DEFINE_integer(
    'image_size', 384,
    'Default input image size for the generated TensorFlow Lite checkpoint.')
FLAGS = flags.FLAGS
...
def main(unused_argv=None):
  ...
  # Define output TF Lite checkpoint path
  ...
  # Convert the SavedModels to float and weight quantized TF Lite checkpoint
