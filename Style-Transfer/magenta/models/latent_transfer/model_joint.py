...
"""The joint transfer model that bridges latent spaces of dataspace checkpoint.

The whole experiment handles transfer between latent space
of generative checkpoint that model the data. This file defines the joint model
that checkpoint the transfer between latent spaces (z1, z2) of checkpoint on dataspace.
"""
